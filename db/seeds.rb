...
# Examples:
#
#   movies = Movie.create([Book.create({ name: 'Star Wars' }), Book.create({ name: 'Lord of the Rings' })])
#   Character.create(name: 'Luke', movie: movies.first)

Library.create(librarian:"Andrew", library_name:"Library of Congress")
Library.create(librarian:"Miles", library_name:"Library of Alexandria")
Library.create(librarian:"Aaron", library_name:"Library of Anime")
Library.create(librarian:"Wei", library_name:"Library of Manga")
  ...
  booksArray.each do |book_obj|
    Book.create(title: book_obj[:title], author: book_obj[:author], year_published: book_obj[:year], country_of_origin: book_obj[:country], bookcover_img: book_obj[:imageLink], original_language: book_obj[:language], pages: book_obj[:pages], info_link: book_obj[:link])
  end


LibraryBook.create(library_id: 1, book_id: 1)
LibraryBook.create(library_id: 1, book_id: 2)
LibraryBook.create(library_id: 1, book_id: 3)
LibraryBook.create(library_id: 1, book_id: 4)
LibraryBook.create(library_id: 1, book_id: 5)